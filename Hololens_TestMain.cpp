...
Hololens_TestMain::Hololens_TestMain(std::shared_ptr<DX::DeviceResources> const& deviceResources) :
    m_deviceResources(deviceResources)
{
    ...
    m_gamepadAddedEventToken = Gamepad::GamepadAdded(bind(&Hololens_TestMain::OnGamepadAdded, this, _1, _2));
    m_gamepadRemovedEventToken = Gamepad::GamepadRemoved(bind(&Hololens_TestMain::OnGamepadRemoved, this, _1, _2));
    ...
    if (m_canGetDefaultHolographicDisplay)
    {
        ...
        m_holographicDisplayIsAvailableChangedEventToken = HolographicSpace::IsAvailableChanged(bind(&Hololens_TestMain::OnHolographicDisplayIsAvailableChanged, this, _1, _2));
    }
...
void Hololens_TestMain::SetHolographicSpace(HolographicSpace const& holographicSpace)
{
    ...
    m_cameraAddedToken = m_holographicSpace.CameraAdded(std::bind(&Hololens_TestMain::OnCameraAdded, this, _1, _2));
    ...
    m_cameraRemovedToken = m_holographicSpace.CameraRemoved(std::bind(&Hololens_TestMain::OnCameraRemoved, this, _1, _2));
...
void Hololens_TestMain::UnregisterHolographicEventHandlers()
{
...
Hololens_TestMain::~Hololens_TestMain()
{
...
HolographicFrame Hololens_TestMain::Update(HolographicFrame const& previousFrame)
{
...
bool Hololens_TestMain::Render(HolographicFrame const& holographicFrame)
{
...
void Hololens_TestMain::SaveAppState()
{
    //
...
void Hololens_TestMain::LoadAppState()
{
    //
...
void Hololens_TestMain::OnPointerPressed()
{
    m_pointerPressed = true;
}
...
void Hololens_TestMain::OnLocatabilityChanged(SpatialLocator const& sender, winrt::Windows::Foundation::IInspectable const& args)
{
...
void Hololens_TestMain::OnCameraAdded(
...
void Hololens_TestMain::OnCameraRemoved(
    HolographicSpace const& sender,
...
void Hololens_TestMain::OnGamepadAdded(winrt::Windows::Foundation::IInspectable, Gamepad const& args)
{
...
void Hololens_TestMain::OnGamepadRemoved(winrt::Windows::Foundation::IInspectable, Gamepad const& args)
{
...
void Hololens_TestMain::OnHolographicDisplayIsAvailableChanged(winrt::Windows::Foundation::IInspectable, winrt::Windows::Foundation::IInspectable)
{
    ...
    if (m_spatialLocator != spatialLocator)
    {
        ...
        if (spatialLocator != nullptr)
        {
            ...
            m_locatabilityChangedToken = m_spatialLocator.LocatabilityChanged(std::bind(&Hololens_TestMain::OnLocatabilityChanged, this, _1, _2));
