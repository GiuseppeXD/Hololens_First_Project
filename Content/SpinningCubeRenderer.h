...
namespace Hololens_Test
{
    ...
    public:
        ...
        void Update(DX::StepTimer const& timer, winrt::Windows::Foundation::Numerics::float3 const& pointerPose);
        void Render();
    ...
    private:
        ...
        Microsoft::WRL::ComPtr<ID3D11Buffer>            m_eyeBuffer;
        Microsoft::WRL::ComPtr<ID3D11Resource>          m_Res;
        Microsoft::WRL::ComPtr<ID3D11ShaderResourceView> m_triangleTexture;
        Microsoft::WRL::ComPtr<ID3D11ShaderResourceView> m_transferFunc;
        Microsoft::WRL::ComPtr<ID3D11SamplerState>      m_triangleTexSamplerState;

        // System resources for cube geometry.
        ModelConstantBuffer                             m_modelConstantBufferData;
        DirectX::XMFLOAT4 m_eyeBufferData;
        uint32_t                                        m_indexCount = 0;

        // Variables used with the rendering loop.
        bool                                            m_loadingComplete = false;
        float                                           m_degreesPerSecond = 45.f;
        winrt::Windows::Foundation::Numerics::float3    m_position = { 0.f, 0.f, -0.5f };
