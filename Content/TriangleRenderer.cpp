...
TriangleRenderer::TriangleRenderer(std::shared_ptr<DX::DeviceResources> const& deviceResources) :
...
void TriangleRenderer::PositionHologram(SpatialPointerPose const& pointerPose)
{
...
void TriangleRenderer::Update(DX::StepTimer const& timer)
{
    // Rotate the cube.
...
void TriangleRenderer::ReleaseDeviceDependentResources()
{
